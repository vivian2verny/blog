...
import need from "../assets/request.svg";

function SpaceInfo() {
  return (
    <section className="info" id='startbuilding' style={{background: "#000"}}>
      <div className="container">
        ...
        <div className="row mt-9 justify-content-center space-info">
                  ...
                  <Form>
                    ...
                    <div className='text-center'>
                      <button
                        ...
                        to="" style={{background: '#245FE0', color: "#fff"}}
                      >
                        Submit
                      </button>
                    </div>
