  ...
  return (
    <section className="info">
      <div className="container">
        ...
        <div className="row mt-9 justify-content-center fin-info">
                ...
                <div className='col-sm-10'>
                  <Form>
                    ...
                    <div className='text-center'>
                      <button
                        className="btn btn-primary btn-000 rounded-pill px-5 py-4 mt-5"
                        to="" style={{background: "#1E2C31"}}
                      >
                        Submit
                      </button>
                    </div>
              ...
              <div className='row mt-5 justify-content-center'>
                <div className='col-sm-10'>
                  <Form>
                    ...
                    <div className='text-center'>
                      <button
                        className="btn btn-000 btn-green rounded-pill px-5 py-4 mt-5"
                        to="" style={{background: "#1E2C31"}}
                      >
                        Submit
                      </button>
