        ...
        <div className="col-md-12">
              ...
              <div className="text-center my-5">
                ...
                <div className=" d-flex justify-content-start  my-4">
                  ...
                  <p>
                    <span>
                      {" "}
                      Tochukwu Tabansi <span className="mx-3">
                        {" "}
                        2 hours ago
                      </span>{" "}
                    </span>{" "}
           ...
           <div className="row">
            ...
            <div className="col-md-4 mb-3">
              ...
              <p>
                <span>
                  {" "}
                  Tochukwu Tabansi <span className="mx-3"> 2 hours ago</span>{" "}
                </span>{" "}
              </p>
              <h3 className="my-3">
              Steps to ensure your business is getting the best out of Stackivy's financial management service
              </h3>
              <div className="">
                <button
                  className="btn next-blog  rounded-pill "
            ...
            <div className="col-md-4 mb-3">
              ...
              <h3 className="my-3">  How to apply for a business loan on Stackivy</h3>
              <div className="">
                <button
                  className="btn next-blog  rounded-pill "
                  type="button"
          ...
          <div className="row  justify-content-center mt-5">
            ...
            <div className="col-md-4 mb-3">
              ...
              <h3 className="my-3">
                {" "}
                Stackivy products that help you with personal financial goals
              </h3>
              <div className="">
                <button
                  className="btn next-blog  rounded-pill "
          ...
          <div className="row  justify-content-center my-5">
            <div className="col-md-4 mb-3">
              ...
              <h3 className="my-3"> How to apply for a personal loan on Stackivy </h3>
