...
import need from "../assets/needblack.svg";

function BlackInfo() {
  return (
    <section className="info" id='startbuilding' style={{background: "#01183B"}}>
      <div className="container">
        <div className="row justify-content-center">
          <div className="col-sm-6 text-center">
            <img src={need} alt="needmore" className='img-fluid' />
            <h6 className="mt-4 text-white">Choose which of our products you want to be contacted for by filling the form below</h6>
          </div>
        </div>
        <div className="row mt-9 justify-content-center black-info">
                  ...
                  <Form>
                    ...
                    <div className='text-center'>
                      <button
                        ...
                        to="" style={{background: 'linear-gradient(90.23deg, #FFDA6D 6.23%, #D7DBFF 45.76%, #47AA8B 101.44%)', color: "#000"}}
                      >
                        Submit
                      </button>
                    </div>
